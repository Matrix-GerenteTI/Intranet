...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.otherScripts = function() {
        ...
        if ($.isFunction($.fn.typeahead)) {
            ...
            var states = ['Pedro Fernandez Burguete', 'Jose Molina Gutierrez', 'Daniela Juarez Becerra'];
            ...
            var names = new Bloodhound({
                ...
                limit: 10,
                prefetch: {
                    url: 'controladores/con_egresos.php?opc=buscaProveedor',
