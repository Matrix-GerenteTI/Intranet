		...
		<div class="col-md-12">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="saldosBancarios"> 
					...
					<div class="row">
						<hr>
						<div class="col-md-3"><label>Cuenta:</label>
						 <select name="" class="form-control" id="filtroSaldoCuenta">
						 	<option value="%">TODAS</option>
						</select></div>
						<div class="col-md-3"><label>Beneficiario:</label> <input type="text" name="" class="form-control" id="filtroSaldoBeneficiario"></div>
						<div class="col-md-3"><label>Fecha: </label><input type="text" name="" class="form-control" id="filtroSaldoFecha" data-format="yyyy/mm/dd" placeholder="mm/aaaa"></div>
						<div class="col-md-3"><br><button class="btn btn-primary" id="filtarrSaldos">Buscar</button></div>
					</div>
					<div class="row">
						<div class="col-md-12" style="text-align:right">
							<ul class="pagination">
								<li class="prev"><a href="#" id="pagAnt">← Anterior</a></li>
								<li class="next"><a href="#" id="pagSig">Siguiente → </a></li>
							</ul>
						</div>
					</div>
					<div class="row">
