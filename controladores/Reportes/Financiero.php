...
class Financiero 
{
    ...
    public function templateBookPage($sucursal = array() , $edoFinanciero , $ventasDetalle = array() , $gastosDetalle = array() )
    {
        ...
        $utilidadBruta = $edoFinanciero[0]['ventas'] - $costos;
        ...
        $this->reporte->getActiveSheet()->setCellValue('D6', $utilidadBruta);
        ...
        $totalGastos = abs($edoFinanciero['gastoOperacion'] ) + abs($edoFinanciero['gastoFinanciero'] );
        ...
        $this->reporte->getActiveSheet()->setCellValue('D11', $totalGastos);   
        ...
        $this->reporte->getActiveSheet()->setCellValue('D13', number_format($utilidad,2,".","" ) );   
        ...
        if( $edoFinanciero[0]['ventas'] != 0){
            $rentabilidad = ( $utilidad / $edoFinanciero[0]['ventas'] ) ;
        }
        ...
        $this->reporte->getActiveSheet()->setCellValue('D15', $rentabilidad);   
        ...
        if ( sizeof( $ventasDetalle) ) {
            ...
            foreach ($ventasDetalle as $fecha => $importe) {
                ...
                $this->reporte->getActiveSheet()->getStyle("I$i")->getNumberFormat()->setFormatCode(\PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
    ...
    public function preparaReporte( $fechaInicio , $fechaFin)
    {
        ...
        $reporteTerminado->save("ReporteFinanciero.xlsx");
         ...
         return "controladores/Reportes/ReporteFinanciero.xlsx";
    }
