...
*/
    ...
    public function preparaReporte($data)
    {
        ...
        foreach ($listaArticulosDesagrupados as $codigo => $articulo) {
            ...
            $des = mb_convert_encoding($articulo['DESCRIP'], 'UTF-8', 'ISO-8859-1');
            $ford = "FORD";
            $chevrolete = "CHEVROLETE";
            $chevrolet = "CHEVROLET";
            $nissan = "NISSAN";
            $jeep = "JEEP";
            $toyota = "TOYOTA";
            ...
            $shadow = "SHADOW";
            $mazda = "MAZDA";
            $cford = strpos($des,$ford);
            $cchevrolete = strpos($des,$chevrolete);
            $cnissan = strpos($des,$nissan);
            $cjeep = strpos($des,$jeep);
            $ctoyota = strpos($des,$toyota);
            $cvolkswagen = strpos($des,$volkswagen);
            $chonda = strpos($des,$honda);
            $cmitsubishi = strpos($des,$mitsubishi);
            $cram = strpos($des,$ram);
            $cchrysler = strpos($des,$chrysler);
            $crenault = strpos($des,$renault);
            $cdodge = strpos($des,$dodge);
            $cpontiac = strpos($des,$pontiac);
            $cshadow = strpos($des,$shadow);
            $cmazda = strpos($des,$mazda);
            ...
            if ( $familia  == 'LLANTA' ) {
                ...
                if ( $familia == 'RIN' ) {
                    ...
                    if ( $familia == 'COLISION' || $familia == 'ACCESORIO') {
                        if ($cford != false) {
                            $libroEdicion->setCellValue("E$i",$ford);
                        } else if($cchevrolete != false) {
                            $libroEdicion->setCellValue("E$i",$chevrolete);
                        } else if($cnissan != false) {
                            $libroEdicion->setCellValue("E$i",$nissan);
                        } else if($cjeep != false) {
                            $libroEdicion->setCellValue("E$i",$jeep);
                        } else if($ctoyota != false) {
                            $libroEdicion->setCellValue("E$i",$toyota);
                        } else if($cvolkswagen != false) {
                            $libroEdicion->setCellValue("E$i",$volkswagen);
                        } else if($cchevrolet != false) {
                            $libroEdicion->setCellValue("E$i",$chevrolet);
                        } else if($chonda != false) {
                            $libroEdicion->setCellValue("E$i",$honda);
                        } else if($cmitsubishi != false) {
                            $libroEdicion->setCellValue("E$i",$mitsubishi);
                        } else if($cram != false) {
                            $libroEdicion->setCellValue("E$i",$ram);
                        } else if($cchrysler != false) {
                            $libroEdicion->setCellValue("E$i",$chrysler);
                        } else if($crenault != false) {
                            $libroEdicion->setCellValue("E$i",$renault);
                        } else if($cdodge != false) {
                            $libroEdicion->setCellValue("E$i",$dodge);
                        } else if($cpontiac != false) {
                            $libroEdicion->setCellValue("E$i",$pontiac);
                        } else if($cshadow != false) {
                            $libroEdicion->setCellValue("E$i",$shadow);
                        } else if($cmazda != false) {
                            $libroEdicion->setCellValue("E$i",$mazda);
                        } else {
