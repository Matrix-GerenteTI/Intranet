           ...
           $articulos[$i]->COSTO *= 1.16;
            if (  isset( $articulosAgrupados[ $articulo->CODIGO ] ) ) {
                ...
                if($articulo->ZONA=='COSTA')
                    $articulosAgrupados[ $articulo->CODIGO ]['stockcosta'] +=  $articulo->EXISTOTAL;
                $articulosAgrupados[ $articulo->CODIGO ]['stock'] =  $articulo->EXISTOTAL;
                $articulosAgrupados[ $articulo->CODIGO ]["costo"] =  round($articulo->COSTO,2);
                $articulosAgrupados[ $articulo->CODIGO ]["diasInv"] =  $diasInv;
                $articulosAgrupados[ $articulo->CODIGO ]["diasInv"] =  $diasInv;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad1"] =  round( ($articulo->PVP1 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad2"] =  round( ($articulo->PVP2 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad3"] =  round( ($articulo->PVP3 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad4"] =  round( ($articulo->PVP4 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad5"] =  round( ($articulo->PVP5 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad6"] =  round( ($articulo->PVP6 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
                $articulosAgrupados[ $articulo->CODIGO ]["utilidad7"] =  round( ($articulo->PVP7 - $articulo->COSTO ) /$articulo->COSTO , 2) * 100 ;
