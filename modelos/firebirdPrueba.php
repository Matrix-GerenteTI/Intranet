...
// define('HOST',"172.16.0.222:C:\\Prediction\\BDs Pruebas\\Prediction.fdb");
// // define('HOST',"172.16.0.70:/var/lib/firebird/3.0/data/PREDICTION.FDB");
// define("USER",'SYSDBA');
...
class FirebirdPruebaDB
{
    protected  $conexionFireBird;

    public function __construct()
    {
        $host = "172.16.0.222:C:\\Prediction\\BDs Pruebas\\Prediction.fdb";
		$user="SYSDBA";
		$pass="masterkey";
