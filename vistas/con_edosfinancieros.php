					...
					<div class="row">
						<div class="col-md-2">
							...
							<div class="form-group">
								...
								<select class="form-control" id="udn"></select>
							</div>	
						...
						<div class="col-md-2">
							<br>
							<button class="btn btn-purple btn-block" id="downResultados">Estado Resultados</button>
						</div>
						<div class="col-md-2">
							<br>
							<!-- <button class="btn btn-danger btn-block" id="downResultadosGral">Edo. de Resultados</button> -->
						</div>						
					</div>
					<hr/>
					<div class="row">
