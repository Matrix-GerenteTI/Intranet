		...
		<div class="content-body">
			<div class="row">
				...
				<div class="col-md-3 col-sm-5 col-xs-12">
					...
					<div class="r1_maingraph db_box">
						<span class='bold'>VENDEDORES</span>
						<span class='pull-right'><small>REPORTE EXCEL</small></span>
						<div class="clearfix"></div>
						<button type="button" class="btn btn-default" onclick="window.open('')">Generar...</button>
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="r1_maingraph db_box">
						<span class='bold'>INDICADOR DE VENTAS</span>
						<span class='pull-right'><small>REPORTE EXCEL</small></span>
						<div class="clearfix"></div>
						<button type="button" class="btn btn-default" onclick="window.open('')">Generar...</button>
						<!--
				...
				<div class="col-md-3 col-sm-12 col-xs-12">
					...
					<div class="r1_maingraph db_box">
						<span class='bold'>SUCURSALES/FAMILIAS</span>
						<span class='pull-right'><small>REPORTE EXCEL</small></span>
						<div class="clearfix"></div>
						<button type="button" class="btn btn-default" onclick="window.open('')">Generar...</button>
			...
			<div class="row">
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="r1_maingraph db_box">
						<span class='bold'>ACUMULADO POR VOLUMEN</span>
						<span class='pull-right'><small>REPORTE EXCEL</small></span>
						<div class="clearfix"></div>
						<button type="button" class="btn btn-default" onclick="window.open('')">Generar...</button>
