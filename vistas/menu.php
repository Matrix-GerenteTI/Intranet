		...
		<div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
			...
			?>
				...
				<li class="<?php echo strpos(strtoupper($pag),'SGC_')===false?'':'open'; ?>">					
					...
					<ul class="sub-menu" >	
						<li>
							<a href="index.php?view=SGC_recursos">Recursos</a>
						</li>
						<?php if($_SESSION['nivel']=='ADMINISTRADOR'){ ?>
						<li>
							<a href="index.php?sgc_principal">Organigramas</a>
						</li>
						<?php } ?>
					</ul>	
				</li>
				<li class="<?php echo strpos($pag,'Direccion_')===false?'':'open'; ?>">					
					...
					<ul class="sub-menu" >	
						<li>
							<a href="index.php?view=Direccion_recursos">Recursos</a>
						</li>
					</ul>	
				</li>
				<li class="<?php echo substr($pag,0,4)=='con_'?'open':''; ?>"> 
					...
					<ul class="sub-menu" >	
						...
						<li class="<?php echo $pag=='con_cuentas'?'open':''; ?>">
							<a  href="index.php?con_cuentas">Cuentas</a>
						</li>
						<li class="<?php echo $pag=='con_ingresos'?'open':''; ?>">
							<a href="index.php?con_ingresos">Ingresos</a>
						</li>
						-->
						<li>
							<a href="index.php?view=Administrativo_recursos">Recursos Administrativos</a>
						</li>							
						<li class="<?php echo $pag=='con_egresos'?'open':''; ?>">
							<a href="index.php?con_egresos">Gastos</a>
						</li>
						<li>
						...
						<li>
							<a class="<?php echo $pag=='con_edosfinancieros'?'open':''; ?>" href="index.php?con_edosfinancieros">Estados Financieros</a>
                        </li>
                        <li>
						...
						<?php } ?>
						<li>
							<a href="index.php?con_activos">Activos Fijos</a>
                        </li>
                        <?php if( $_SESSION['nivel'] == '1' ): ?>
						<li>
				...
				<li class="<?php echo substr($pag,0,4)=='per_'?'open':''; ?>"> 
					...
					<ul class="sub-menu" >
                        <li>
							<a href="index.php?baja_colaboradores">Bajas colaboradores</a>
						</li>		
						<li>
							<a href="index.php?view=RH_recursos">Recursos</a>
						</li>		
						<li> 
							<a href="index.php?per_acorrectiva">Acciones Correctivas</a>
						</li>
						<li class="">
						...
						<li class="<?php echo $pag=='per_socioeconomico'?'open':''; ?>">
							<a  href="index.php?per_socioeconomico">Evidencias Socioeconómico</a>
						</li>																			
						<li class="<?php echo $pag=='per_kpis'?'open':''; ?>">
							<a  href="index.php?per_kpi">Indicador Clave de Rendimiento (PRUEBAS)</a>
						</li>
						<!--
						<li class="<?php //echo $pag=='per_areas'?'open':''; ?>">
							<a href="index.php?per_areas">Areas y Puestos</a>
						</li>-->
						<li class="<?php echo $pag=='per_tareas'?'open':''; ?>">
							<a href="index.php?per_tareas">Tareas</a>
						</li>
						...
						<li class="<?php echo $pag=='resguardos'?'open':''; ?>">
							<a href="index.php?resguardos">Resguardos</a>
						</li>
				...
				<li class="<?php echo strpos($pag,'ventas_')===false?'':'open'; ?>">
					...
					<ul class="sub-menu">
						<li>
							<a href="index.php?view=ventas_recursos">Recursos</a>
						</li>
						<li>
							<a href="index.php?view=precios_recursos">Precios</a>
						</li>						
						<li>
							<a href="index.php?ventas_clasificador">Catalogo Suc.</a>
						</li>
						<li>
							<a href="index.php?aleatorios_excepciones">Inventarios aleatorios (Excepciones)</a>
                        </li>
					</ul>					
                </li>			
				...
				<a href="javascript:;">
					...
					<ul class="sub-menu" >	
						<li>
							<a href="index.php?view=compras_recursos">Recursos</a>
						</li>
					</ul>							
				</li>		
				<li class="<?php echo strpos($pag,'almacen_')===false?'':'open'; ?>">
					...
					<ul class="sub-menu" >	
						<li>
							<a href="index.php?view=almacen_recursos">Recursos</a>
                        </li>
						<li>
				...
				?>
					<li class="<?php echo strpos($pag,'precios_')===false?'':'open'; ?>">
						<a href="index.php?precios_productos">
				...
				<li class="<?php echo strpos($pag,'ti_')===false?'':'open'; ?>">
					...
					<ul class="sub-menu" >	
						<li>
							<a href="index.php?view=ti_recursos">Recursos</a>
						</li>
					</ul>							
				</li>
				<?php 
